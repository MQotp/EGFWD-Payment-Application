...
EN_terminalError_t getTransactionDate(ST_terminalData_t* termData)
{
    ...
    else if (termData->transactionDate[0] < 48 || termData->transactionDate > 51)
    {
        return WRONG_DATE;
    }
    else if (termData->transactionDate[1] < 48 || termData->transactionDate > 57)
    {
        return WRONG_DATE;
    }
    else if (termData->transactionDate[3] < 48 || termData->transactionDate > 49) /*12 months*/
    {
        return WRONG_DATE;
    }
    else if (termData->transactionDate[4] < 48 || termData->transactionDate > 57)
    {
        return WRONG_DATE;
    }
    else if (termData->transactionDate[6] < 48 || termData->transactionDate > 57)
    {
        return WRONG_DATE;
    }
    else if (termData->transactionDate[7] < 48 || termData->transactionDate > 57)
    {
        return WRONG_DATE;
    }
    else if (termData->transactionDate[8] < 48 || termData->transactionDate > 57)
    {
        return WRONG_DATE;
    }
    else if (termData->transactionDate[9] < 48 || termData->transactionDate > 57)
    {
        return WRONG_DATE;
    }
    return TERMINAL_OK;
